...
public final class OrdenesForm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addComponent(txtNumeroSerie, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jPanel5, javax.swing.GroupLayout.PREFERRED_SIZE, 289, Short.MAX_VALUE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
 ...
 void generarNumeroSerie() {
        String serie = odao.numeroSerie();
        if (serie == null) {
            txtNumeroSerie.setText("1");
        } else {
            int incrementar = Integer.parseInt(serie);
            incrementar = incrementar + 1;

            txtNumeroSerie.setText("" + incrementar);
    ...
    void guardarOrden() {
        ...
        float totalPago = totalOrden;

        orden.setNumeroSerie(numeroSerie);
        orden.setNombreCliente(nombreCliente);
        orden.setTotalOrden(totalPago);

        odao.guardarOrden(orden);
    }

    void guardarVenta() {
        String idOrd = odao.IdOrden();
        int idOrden = Integer.parseInt(idOrd);

        for (int i = 0; i < tablaOrden.getRowCount(); i++) {
            int idProduct = Integer.parseInt(tablaOrden.getValueAt(i, 0).toString());
            int cantidad = Integer.parseInt(tablaOrden.getValueAt(i, 2).toString());
            float totalVenta = Float.parseFloat(tablaOrden.getValueAt(i, 4).toString());

            venta.setIdOrden(idOrden);
            venta.setIdProducto(idProduct);
            venta.setCantidad(cantidad);
            venta.setTotalVenta(totalVenta);

            odao.guardarVentas(venta);
        }
    }
